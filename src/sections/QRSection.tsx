...
const socialLinks = [
  ...
  },
  {
    ...
    icon: Instagram,
    iconColor: '#E4405F',
    url: 'https://instagram.com/centrocalorterapeutico',
    description: 'Conoce nuestros servicios',
    qrValue: 'https://instagram.com/centrocalorterapeutico',
  },
  {
    name: 'TikTok',
    icon: Music2,
    iconColor: '#000000',
    url: 'https://tiktok.com/@centrocalorterapeutico',
    description: 'Tips de salud y bienestar',
    qrValue: 'https://tiktok.com/@centrocalorterapeutico',
  },
  {
    name: 'WhatsApp',
    icon: Phone,
